...
import com.ncs.sprinbase.core.exception.InnerError;
import com.ncs.sprinbase.core.exception.ServiceException;
import com.ncs.sprinbase.core.exception.UnAuthException;
import com.ncs.sprinbase.core.exception.ValidatorException;
    ...
    public static InnerError handleException(HttpServletRequest request, HttpServletResponse response, Throwable e) {
        ...
        if (e instanceof ValidatorException) {
            ...
            if (bindingResult.hasErrors()) {
                errorMsg = "参数异常:"
                           + bindingResult.getFieldErrors().stream().map(FieldError::getDefaultMessage).collect(
                               Collectors.joining("\n"));
            }
