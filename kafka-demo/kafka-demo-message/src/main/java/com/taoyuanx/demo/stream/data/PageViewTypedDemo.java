...
import com.taoyuanx.demo.stream.MyJsonTimestampExtractor;
...
public class PageViewTypedDemo {
    ...
    public static  void officalExample(){
        final Properties props = new Properties();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "streams-pageview-typed1");
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaProperties.servers);
        ...
        final KStream<WindowedPageViewByRegion, RegionCount> regionCount = views
                ...
                .windowedBy(TimeWindows.of(Duration.ofDays(7)).advanceBy(Duration.ofMinutes(7)))
                .count()
                .toStream()
                .map((key, value) -> {
